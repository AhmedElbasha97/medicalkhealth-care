...
class ReminderWelcome extends StatefulWidget {
  @override
  _ReminderWelcomeState createState() => _ReminderWelcomeState();
}

class _ReminderWelcomeState extends State<ReminderWelcome> {
  @override
  Widget build(BuildContext context) {
    ...
    void goToHomeScreen() => Navigator.push(
        context, MaterialPageRoute(builder: (context) => ReminderHome()));
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
